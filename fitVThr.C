...
float eff[] = {0.9377 , 0.9052 , 0.7918 , 0.5866 , 0.3090 , 0.2194 ,/* 0.0827*/};
...
cG1f->SetFillColor(0);
cG1f->cd();
TGraphErrors *gG1f = new TGraphErrors(5,V_threshold,eff,err_V_threshold,err_eff);
...
cout << "\n\n --- Ipotesi  [2]/(1+exp((x-[1])/[2])) --- \n" <<endl;

TF1 *funz1 = new TF1("funz1"," [2]/(1+exp((x-[0])/[1]))",30,250000);

funz1->SetParameter(2,0.95);
funz1->SetParameter(0,120.);
funz1->SetParameter(1,100.);
funz1->SetParLimits(2,0.0,3.);
