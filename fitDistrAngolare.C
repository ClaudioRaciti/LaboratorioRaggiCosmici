...
float err_rate[] = {0.0249,0.0227,0.0225,0.0177,0.0122};
// float err_rate[] = {0.0325,0.0302,0.0298,0.0244,0.0171};
...
cout << "\n\n --- Ipotesi  [0] * pow(cos(x*3.141592/180),[1])+[2] --- \n" <<endl;

TF1 *funz1 = new TF1("funz1","[0] * pow(cos(x*3.141592/180),[1])+[2]",-0.1,250000);

funz1->SetParameter(0,0.5);
funz1->SetParameter(2,0.);
funz1->SetParameter(1,2.);
// funz1->SetParLimits(0,0.,1.);
funz1->SetParLimits(1,0.,4.);
gG1f->Fit(funz1,"RM+");
